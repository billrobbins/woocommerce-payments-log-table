 ...
 *
 * Handles the display of payment history in order admin
 */
class WC_Payments_Log_Table_Metabox {
	/**
	 * Logger instance
				...
				<tbody>
					...
					<?php else : ?>
						...
						foreach ( $events as $event ) :
							...
							if ( WC_Payments_Logger::EVENT_TYPE_PAYMENT === $event->event_type ) {
							...
							<tr>
								...
								<td>
									<?php if ( WC_Payments_Logger::EVENT_TYPE_PAYMENT === $event->event_type ) : ?>
